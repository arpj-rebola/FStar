...
// These options require to restart Z3 since they either are provided
// via command-line arguments (z3seed, z3cliopt) or prune the context
// given to Z3 (using_facts_from).

let requires_solver_restart s = s="z3seed" || s="z3cliopt" || s="using_facts_from"
let all_specs = specs ()
