...
let get_analyze_proof : unit  ->  Prims.bool = (fun uu____3422 -> (lookup_opt "analyze_proof" as_bool))
...
in Const (uu____7593))
in ((FStar_Getopt.noshort), ("analyze_proof"), (uu____7592), ("Analyzes proofs and quantifier instantiations obtained from Z3")))
in (uu____7580)::[])
...
let analyze_proof : unit  ->  Prims.bool = (fun uu____11736 -> (get_analyze_proof ()))
