...
let has_cygpath : Prims.bool = (FStar_All.try_with (fun uu___67_5 -> (match (()) with
| () -> begin
(
...
let string_of_option : 'Auu____459 . ('Auu____459  ->  Prims.string)  ->  'Auu____459 FStar_Pervasives_Native.option  ->  Prims.string = (fun f uu___65_476 -> (match (uu___65_476) with
| FStar_Pervasives_Native.None -> begin
"None"
end
| FStar_Pervasives_Native.Some (x) -> begin
