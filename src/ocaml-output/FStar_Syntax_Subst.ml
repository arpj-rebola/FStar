...
let map_some_curry : 'Auu____143 'Auu____144 'Auu____145 . ('Auu____143  ->  'Auu____144  ->  'Auu____145)  ->  'Auu____145  ->  ('Auu____143 * 'Auu____144) FStar_Pervasives_Native.option  ->  'Auu____145 = (fun f x uu___95_172 -> (match (uu___95_172) with
| FStar_Pervasives_Native.None -> begin
x
end
...
let subst_bv : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option = (fun a s -> (FStar_Util.find_map s (fun uu___96_899 -> (match (uu___96_899) with
...
let subst_nm : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option = (fun a s -> (FStar_Util.find_map s (fun uu___97_936 -> (match (uu___97_936) with
...
let uu___103_950 = a
in {FStar_Syntax_Syntax.ppname = uu___103_950.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___103_950.FStar_Syntax_Syntax.sort}))
...
let subst_univ_bv : Prims.int  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe FStar_Pervasives_Native.option = (fun x s -> (FStar_Util.find_map s (fun uu___98_986 -> (match (uu___98_986) with
...
let subst_univ_nm : FStar_Syntax_Syntax.univ_name  ->  FStar_Syntax_Syntax.subst_elt Prims.list  ->  FStar_Syntax_Syntax.universe FStar_Pervasives_Native.option = (fun x s -> (FStar_Util.find_map s (fun uu___99_1015 -> (match (uu___99_1015) with
...
let uu___104_1122 = fv.FStar_Syntax_Syntax.fv_name
in (

let uu____1123 = (FStar_Ident.set_lid_range l r1)
in {FStar_Syntax_Syntax.v = uu____1123; FStar_Syntax_Syntax.p = uu___104_1122.FStar_Syntax_Syntax.p}))
in (

let fv1 = (

let uu___105_1125 = fv
in {FStar_Syntax_Syntax.fv_name = v1; FStar_Syntax_Syntax.fv_delta = uu___105_1125.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu___105_1125.FStar_Syntax_Syntax.fv_qual})
...
let uu___106_1127 = t
in {FStar_Syntax_Syntax.n = t'; FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu___106_1127.FStar_Syntax_Syntax.vars})))
end))
end))
...
and subst_flags' : FStar_Syntax_Syntax.subst_ts  ->  FStar_Syntax_Syntax.cflag Prims.list  ->  FStar_Syntax_Syntax.cflag Prims.list = (fun s flags -> (FStar_All.pipe_right flags (FStar_List.map (fun uu___100_1424 -> (match (uu___100_1424) with
...
in {FStar_Syntax_Syntax.ppname = uu___108_1798.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___108_1798.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1799}))
in (
...
let uu___109_2328 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___109_2328.FStar_Syntax_Syntax.p})), (n2))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___110_2354.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___110_2354.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2355}))
in (((

let uu___111_2360 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___111_2360.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___112_2373.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___112_2373.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2374}))
in (((

let uu___113_2379 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___113_2379.FStar_Syntax_Syntax.p})), ((n1 + (Prims.parse_int "1"))))))
end
...
in {FStar_Syntax_Syntax.ppname = uu___114_2397.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___114_2397.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2398}))
in (

let t01 = (subst' s1 t0)
in (((

let uu___115_2404 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___115_2404.FStar_Syntax_Syntax.p})), (n1)))))
end))
...
let uu___116_2431 = rc
in (

let uu____2432 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (subst' s))
in {FStar_Syntax_Syntax.residual_effect = uu___116_2431.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____2432; FStar_Syntax_Syntax.residual_flags = uu___116_2431.FStar_Syntax_Syntax.residual_flags}))
...
let rec aux = (fun uu___102_2507 -> (match (uu___102_2507) with
| [] -> begin
[]
end
| (hd_subst)::rest -> begin
...
let hd1 = (FStar_All.pipe_right hd_subst (FStar_List.collect (fun uu___101_2538 -> (match (uu___101_2538) with
...
let uu___117_2583 = x
in {FStar_Syntax_Syntax.ppname = uu___117_2583.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___117_2583.FStar_Syntax_Syntax.sort}))
in (
...
in {FStar_Syntax_Syntax.n = uu____2810; FStar_Syntax_Syntax.pos = uu___118_2807.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___118_2807.FStar_Syntax_Syntax.vars}))
...
in {FStar_Syntax_Syntax.ppname = uu___119_3308.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___119_3308.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3309}))
in (
...
let uu___120_3580 = x
in {FStar_Syntax_Syntax.ppname = uu___120_3580.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___120_3580.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lbt}))
end
...
let uu___121_3582 = lb
in {FStar_Syntax_Syntax.lbname = lbname; FStar_Syntax_Syntax.lbunivs = uu___121_3582.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = lbt; FStar_Syntax_Syntax.lbeff = uu___121_3582.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbd; FStar_Syntax_Syntax.lbattrs = uu___121_3582.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___121_3582.FStar_Syntax_Syntax.lbpos})))))))
...
let uu___122_4250 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____4251 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___122_4250.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___122_4250.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4251}))
in (
...
let uu___123_4851 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___123_4851.FStar_Syntax_Syntax.p})), (sub2))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___124_4872 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____4873 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___124_4872.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___124_4872.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4873}))
in (
...
let uu___125_4890 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x'); FStar_Syntax_Syntax.p = uu___125_4890.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___126_4895 = (FStar_Syntax_Syntax.freshen_bv x)
in (

let uu____4896 = (subst sub1 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___126_4895.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___126_4895.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4896}))
in (
...
let uu___127_4913 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x'); FStar_Syntax_Syntax.p = uu___127_4913.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___128_4923.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___128_4923.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4924}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___129_4933 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___129_4933.FStar_Syntax_Syntax.p})), (sub1))))
end))
in (open_pat_aux [] p)))
...
in {FStar_Syntax_Syntax.ppname = uu___130_5120.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___130_5120.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5121}))
in (
...
let uu___131_5537 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___131_5537.FStar_Syntax_Syntax.p})), (sub2))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___132_5558.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___132_5558.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5559}))
in (
...
let uu___133_5576 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.p = uu___133_5576.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___134_5581.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___134_5581.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5582}))
in (
...
let uu___135_5599 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.p = uu___135_5599.FStar_Syntax_Syntax.p})), (sub2))))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t0) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___136_5609.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___136_5609.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5610}))
in (

let t01 = (subst sub1 t0)
in (((

let uu___137_5619 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t01))); FStar_Syntax_Syntax.p = uu___137_5619.FStar_Syntax_Syntax.p})), (sub1))))
end))
in (aux [] p)))
...
let uu___138_6000 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___138_6000.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___138_6000.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___138_6000.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___138_6000.FStar_Syntax_Syntax.lbdef; FStar_Syntax_Syntax.lbattrs = uu___138_6000.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___138_6000.FStar_Syntax_Syntax.lbpos}))::lbs1), ((FStar_Syntax_Syntax.DB (((i), (x))))::out)))
...
in {FStar_Syntax_Syntax.lbname = uu___139_6135.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = uu____6136; FStar_Syntax_Syntax.lbeff = uu___139_6135.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____6139; FStar_Syntax_Syntax.lbattrs = uu___139_6135.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___139_6135.FStar_Syntax_Syntax.lbpos})))
end)))))
in (
...
in {FStar_Syntax_Syntax.lbname = uu___140_6334.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___140_6334.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____6335; FStar_Syntax_Syntax.lbeff = uu___140_6334.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____6338; FStar_Syntax_Syntax.lbattrs = uu___140_6334.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___140_6334.FStar_Syntax_Syntax.lbpos})))
end)))))
in (
