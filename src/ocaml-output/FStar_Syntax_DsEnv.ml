...
let uu___204_2132 = env
in {curmodule = uu___204_2132.curmodule; curmonad = uu___204_2132.curmonad; modules = uu___204_2132.modules; scope_mods = uu___204_2132.scope_mods; exported_ids = uu___204_2132.exported_ids; trans_exported_ids = uu___204_2132.trans_exported_ids; includes = uu___204_2132.includes; sigaccum = uu___204_2132.sigaccum; sigmap = uu___204_2132.sigmap; iface = b; admitted_iface = uu___204_2132.admitted_iface; expect_typ = uu___204_2132.expect_typ; docs = uu___204_2132.docs; remaining_iface_decls = uu___204_2132.remaining_iface_decls; syntax_only = uu___204_2132.syntax_only; ds_hooks = uu___204_2132.ds_hooks; dep_graph = uu___204_2132.dep_graph}))
...
let open_modules_and_namespaces : env  ->  FStar_Ident.lident Prims.list = (fun env -> (FStar_List.filter_map (fun uu___171_2359 -> (match (uu___171_2359) with
...
let uu___208_2572 = env
in {curmodule = uu___208_2572.curmodule; curmonad = uu___208_2572.curmonad; modules = uu___208_2572.modules; scope_mods = uu___208_2572.scope_mods; exported_ids = uu___208_2572.exported_ids; trans_exported_ids = uu___208_2572.trans_exported_ids; includes = uu___208_2572.includes; sigaccum = uu___208_2572.sigaccum; sigmap = uu___208_2572.sigmap; iface = uu___208_2572.iface; admitted_iface = uu___208_2572.admitted_iface; expect_typ = uu___208_2572.expect_typ; docs = uu___208_2572.docs; remaining_iface_decls = (((l), (ds)))::rest; syntax_only = uu___208_2572.syntax_only; ds_hooks = uu___208_2572.ds_hooks; dep_graph = uu___208_2572.dep_graph})
end)))
...
let uu___212_2780 = bv.FStar_Syntax_Syntax.ppname
in {FStar_Ident.idText = uu___212_2780.FStar_Ident.idText; FStar_Ident.idRange = r})
in (

let uu___213_2781 = bv
in {FStar_Syntax_Syntax.ppname = id1; FStar_Syntax_Syntax.index = uu___213_2781.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___213_2781.FStar_Syntax_Syntax.sort})))
...
let option_of_cont : 'a . (unit  ->  'a FStar_Pervasives_Native.option)  ->  'a cont_t  ->  'a FStar_Pervasives_Native.option = (fun k_ignore uu___172_3045 -> (match (uu___172_3045) with
| Cont_ok (a) -> begin
...
let string_of_exported_id_kind : exported_id_kind  ->  Prims.string = (fun uu___173_3199 -> (match (uu___173_3199) with
| Exported_id_field -> begin
"field"
end
| Exported_id_term_type -> begin
...
let rec aux = (fun uu___174_3275 -> (match (uu___174_3275) with
| [] -> begin
...
let is_exported_id_field : exported_id_kind  ->  Prims.bool = (fun uu___175_3521 -> (match (uu___175_3521) with
| Exported_id_field -> begin
true
end
| uu____3524 -> begin
...
let check_local_binding_id = (fun uu___176_3648 -> (match (uu___176_3648) with
| (id', uu____3651) -> begin
(Prims.op_Equality id'.FStar_Ident.idText id1.FStar_Ident.idText)
end))
in (

let check_rec_binding_id = (fun uu___177_3659 -> (match (uu___177_3659) with
...
let proc = (fun uu___178_3676 -> (match (uu___178_3676) with
...
let rec aux = (fun uu___179_3700 -> (match (uu___179_3700) with
| (a)::q -> begin
(
...
let rec aux = (fun uu___180_4076 -> (match (uu___180_4076) with
| [] -> begin
(
...
let is_open : env  ->  FStar_Ident.lident  ->  open_kind  ->  Prims.bool = (fun env lid open_kind -> (FStar_List.existsb (fun uu___181_4208 -> (match (uu___181_4208) with
...
let cont_of_option : 'a . 'a cont_t  ->  'a FStar_Pervasives_Native.option  ->  'a cont_t = (fun k_none uu___182_4705 -> (match (uu___182_4705) with
| FStar_Pervasives_Native.Some (v1) -> begin
Cont_ok (v1)
end
| FStar_Pervasives_Native.None -> begin
...
let qopt = (FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals (fun uu___183_4901 -> (match (uu___183_4901) with
...
let uu____4998 = ((FStar_Syntax_Util.is_primop_lid lid) || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___184_5005 -> (match (uu___184_5005) with
...
let uu____5020 = ((FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___185_5026 -> (match (uu___185_5026) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| uu____5029 -> begin
false
end)))) || ((FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___186_5035 -> (match (uu___186_5035) with
...
let uu____5041 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___187_5047 -> (match (uu___187_5047) with
...
let k_global_def = (fun source_lid uu___190_5102 -> (match (uu___190_5102) with
...
let uu____5208 = (any_val || (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___188_5214 -> (match (uu___188_5214) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____5217 -> begin
...
let uu____5225 = (FStar_Util.find_map quals (fun uu___189_5230 -> (match (uu___189_5230) with
...
let k_global_def = (fun lid1 uu___191_5824 -> (match (uu___191_5824) with
...
let k_global_def = (fun lid1 uu___192_5964 -> (match (uu___192_5964) with
...
let k_global_def = (fun lid1 uu___193_6040 -> (match (uu___193_6040) with
...
let uu___214_6413 = env
in {curmodule = uu___214_6413.curmodule; curmonad = uu___214_6413.curmonad; modules = uu___214_6413.modules; scope_mods = []; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___214_6413.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___214_6413.sigaccum; sigmap = uu___214_6413.sigmap; iface = uu___214_6413.iface; admitted_iface = uu___214_6413.admitted_iface; expect_typ = uu___214_6413.expect_typ; docs = uu___214_6413.docs; remaining_iface_decls = uu___214_6413.remaining_iface_decls; syntax_only = uu___214_6413.syntax_only; ds_hooks = uu___214_6413.ds_hooks; dep_graph = uu___214_6413.dep_graph})
...
let uu____6513 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___194_6519 -> (match (uu___194_6519) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____6522 -> begin
...
let k_global_def = (fun lid1 uu___195_6606 -> (match (uu___195_6606) with
...
let is_record = (FStar_Util.for_some (fun uu___196_8322 -> (match (uu___196_8322) with
...
let find_dc = (fun dc -> (FStar_All.pipe_right sigs (FStar_Util.find_opt (fun uu___197_8369 -> (match (uu___197_8369) with
...
in (FStar_All.pipe_right sigs (FStar_List.iter (fun uu___198_8427 -> (match (uu___198_8427) with
...
in (fun uu___199_9234 -> (match (uu___199_9234) with
| Exported_id_term_type -> begin
term_type_set
end
| Exported_id_field -> begin
...
let filter_scope_mods = (fun uu___200_9294 -> (match (uu___200_9294) with
...
let uu___215_9301 = env
in (

let uu____9302 = (FStar_List.filter filter_scope_mods env.scope_mods)
in {curmodule = uu___215_9301.curmodule; curmonad = uu___215_9301.curmonad; modules = uu___215_9301.modules; scope_mods = uu____9302; exported_ids = empty_exported_id_smap; trans_exported_ids = uu___215_9301.trans_exported_ids; includes = empty_include_smap; sigaccum = uu___215_9301.sigaccum; sigmap = uu___215_9301.sigmap; iface = uu___215_9301.iface; admitted_iface = uu___215_9301.admitted_iface; expect_typ = uu___215_9301.expect_typ; docs = uu___215_9301.docs; remaining_iface_decls = uu___215_9301.remaining_iface_decls; syntax_only = uu___215_9301.syntax_only; ds_hooks = uu___215_9301.ds_hooks; dep_graph = uu___215_9301.dep_graph}))
in (
...
let uu___216_9347 = env
in {curmodule = uu___216_9347.curmodule; curmonad = uu___216_9347.curmonad; modules = uu___216_9347.modules; scope_mods = (scope_mod)::env.scope_mods; exported_ids = uu___216_9347.exported_ids; trans_exported_ids = uu___216_9347.trans_exported_ids; includes = uu___216_9347.includes; sigaccum = uu___216_9347.sigaccum; sigmap = uu___216_9347.sigmap; iface = uu___216_9347.iface; admitted_iface = uu___216_9347.admitted_iface; expect_typ = uu___216_9347.expect_typ; docs = uu___216_9347.docs; remaining_iface_decls = uu___216_9347.remaining_iface_decls; syntax_only = uu___216_9347.syntax_only; ds_hooks = uu___216_9347.ds_hooks; dep_graph = uu___216_9347.dep_graph}))
...
let uu___217_9568 = env
in {curmodule = uu___217_9568.curmodule; curmonad = uu___217_9568.curmonad; modules = uu___217_9568.modules; scope_mods = uu___217_9568.scope_mods; exported_ids = uu___217_9568.exported_ids; trans_exported_ids = uu___217_9568.trans_exported_ids; includes = uu___217_9568.includes; sigaccum = (s)::env.sigaccum; sigmap = uu___217_9568.sigmap; iface = uu___217_9568.iface; admitted_iface = uu___217_9568.admitted_iface; expect_typ = uu___217_9568.expect_typ; docs = uu___217_9568.docs; remaining_iface_decls = uu___217_9568.remaining_iface_decls; syntax_only = uu___217_9568.syntax_only; ds_hooks = uu___217_9568.ds_hooks; dep_graph = uu___217_9568.dep_graph});
)
end)))
end))
in (
...
let uu___218_9570 = env1
in (

let uu____9571 = (FStar_ST.op_Bang globals)
in {curmodule = uu___218_9570.curmodule; curmonad = uu___218_9570.curmonad; modules = uu___218_9570.modules; scope_mods = uu____9571; exported_ids = uu___218_9570.exported_ids; trans_exported_ids = uu___218_9570.trans_exported_ids; includes = uu___218_9570.includes; sigaccum = uu___218_9570.sigaccum; sigmap = uu___218_9570.sigmap; iface = uu___218_9570.iface; admitted_iface = uu___218_9570.admitted_iface; expect_typ = uu___218_9570.expect_typ; docs = uu___218_9570.docs; remaining_iface_decls = uu___218_9570.remaining_iface_decls; syntax_only = uu___218_9570.syntax_only; ds_hooks = uu___218_9570.ds_hooks; dep_graph = uu___218_9570.dep_graph}))
in (
...
let uu___219_9997 = env3
in (

let uu____9998 = (FStar_ST.op_Bang globals)
in {curmodule = uu___219_9997.curmodule; curmonad = uu___219_9997.curmonad; modules = uu___219_9997.modules; scope_mods = uu____9998; exported_ids = uu___219_9997.exported_ids; trans_exported_ids = uu___219_9997.trans_exported_ids; includes = uu___219_9997.includes; sigaccum = uu___219_9997.sigaccum; sigmap = uu___219_9997.sigmap; iface = uu___219_9997.iface; admitted_iface = uu___219_9997.admitted_iface; expect_typ = uu___219_9997.expect_typ; docs = uu___219_9997.docs; remaining_iface_decls = uu___219_9997.remaining_iface_decls; syntax_only = uu___219_9997.syntax_only; ds_hooks = uu___219_9997.ds_hooks; dep_graph = uu___219_9997.dep_graph}))
in env4);
)
end)))))))
...
let uu___220_11767 = se
in {FStar_Syntax_Syntax.sigel = uu___220_11767.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___220_11767.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals; FStar_Syntax_Syntax.sigmeta = uu___220_11767.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___220_11767.FStar_Syntax_Syntax.sigattrs})), (false)));
(l)::lids;
));
)
end))
...
let uu___222_11785 = s
in {FStar_Syntax_Syntax.sigel = uu___222_11785.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___222_11785.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::s.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___222_11785.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___222_11785.FStar_Syntax_Syntax.sigattrs})
end
| uu____11786 -> begin
s
end))))
in {FStar_Syntax_Syntax.name = uu___221_11770.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu____11771; FStar_Syntax_Syntax.exports = uu___221_11770.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___221_11770.FStar_Syntax_Syntax.is_interface}))))
...
let uu___224_11993 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp))); FStar_Syntax_Syntax.sigrng = uu___224_11993.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___224_11993.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___224_11993.FStar_Syntax_Syntax.sigattrs})
...
let uu___225_12996 = env
in {curmodule = FStar_Pervasives_Native.None; curmonad = uu___225_12996.curmonad; modules = (((modul.FStar_Syntax_Syntax.name), (modul)))::env.modules; scope_mods = []; exported_ids = uu___225_12996.exported_ids; trans_exported_ids = uu___225_12996.trans_exported_ids; includes = uu___225_12996.includes; sigaccum = []; sigmap = uu___225_12996.sigmap; iface = uu___225_12996.iface; admitted_iface = uu___225_12996.admitted_iface; expect_typ = uu___225_12996.expect_typ; docs = uu___225_12996.docs; remaining_iface_decls = uu___225_12996.remaining_iface_decls; syntax_only = uu___225_12996.syntax_only; ds_hooks = uu___225_12996.ds_hooks; dep_graph = uu___225_12996.dep_graph})
end);
)
end);
));
...
in {curmodule = uu___226_13089.curmodule; curmonad = uu___226_13089.curmonad; modules = uu___226_13089.modules; scope_mods = uu___226_13089.scope_mods; exported_ids = uu____13090; trans_exported_ids = uu____13095; includes = uu____13100; sigaccum = uu___226_13089.sigaccum; sigmap = uu____13111; iface = uu___226_13089.iface; admitted_iface = uu___226_13089.admitted_iface; expect_typ = uu___226_13089.expect_typ; docs = uu____13124; remaining_iface_decls = uu___226_13089.remaining_iface_decls; syntax_only = uu___226_13089.syntax_only; ds_hooks = uu___226_13089.ds_hooks; dep_graph = uu___226_13089.dep_graph}))))));
))))
...
let uu___227_13319 = se
in {FStar_Syntax_Syntax.sigel = uu___227_13319.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___227_13319.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::se.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___227_13319.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___227_13319.FStar_Syntax_Syntax.sigattrs})
end
| uu____13320 -> begin
se
end)
...
in (fun uu___201_13759 -> (match (uu___201_13759) with
| Exported_id_term_type -> begin
terms
end
| Exported_id_field -> begin
...
let as_includes : 'Auu____13896 . 'Auu____13896 Prims.list FStar_Pervasives_Native.option  ->  'Auu____13896 Prims.list FStar_ST.ref = (fun uu___202_13909 -> (match (uu___202_13909) with
| FStar_Pervasives_Native.None -> begin
(FStar_Util.mk_ref [])
end
...
let convert_kind = (fun uu___203_14113 -> (match (uu___203_14113) with
...
let uu___228_14273 = env1
in (

let uu____14274 = (FStar_List.map (fun x -> Open_module_or_namespace (x)) auto_open2)
in {curmodule = FStar_Pervasives_Native.Some (mname); curmonad = uu___228_14273.curmonad; modules = uu___228_14273.modules; scope_mods = uu____14274; exported_ids = uu___228_14273.exported_ids; trans_exported_ids = uu___228_14273.trans_exported_ids; includes = uu___228_14273.includes; sigaccum = uu___228_14273.sigaccum; sigmap = env1.sigmap; iface = intf; admitted_iface = admitted; expect_typ = uu___228_14273.expect_typ; docs = uu___228_14273.docs; remaining_iface_decls = uu___228_14273.remaining_iface_decls; syntax_only = uu___228_14273.syntax_only; ds_hooks = uu___228_14273.ds_hooks; dep_graph = uu___228_14273.dep_graph}))
...
let uu___229_14378 = env
in {curmodule = uu___229_14378.curmodule; curmonad = FStar_Pervasives_Native.Some (mname); modules = uu___229_14378.modules; scope_mods = uu___229_14378.scope_mods; exported_ids = uu___229_14378.exported_ids; trans_exported_ids = uu___229_14378.trans_exported_ids; includes = uu___229_14378.includes; sigaccum = uu___229_14378.sigaccum; sigmap = uu___229_14378.sigmap; iface = uu___229_14378.iface; admitted_iface = uu___229_14378.admitted_iface; expect_typ = uu___229_14378.expect_typ; docs = uu___229_14378.docs; remaining_iface_decls = uu___229_14378.remaining_iface_decls; syntax_only = uu___229_14378.syntax_only; ds_hooks = uu___229_14378.ds_hooks; dep_graph = uu___229_14378.dep_graph})
end))
