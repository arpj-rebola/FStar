...
let equal_if : Prims.bool  ->  FStar_Syntax_Util.eq_result = (fun uu___236_2118 -> (match (uu___236_2118) with
| true -> begin
...
let equal_iff : Prims.bool  ->  FStar_Syntax_Util.eq_result = (fun uu___237_2129 -> (match (uu___237_2129) with
| true -> begin
FStar_Syntax_Util.Equal
end
| uu____2132 -> begin
...
in (FStar_All.try_with (fun uu___239_7696 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___238_7704 -> FStar_Pervasives_Native.None))))
end
| uu____7707 -> begin
FStar_Pervasives_Native.None
end))
