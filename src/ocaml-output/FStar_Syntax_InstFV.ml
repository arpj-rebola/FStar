...
in {FStar_Syntax_Syntax.ppname = uu___97_323.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___97_323.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____324}))
in (
...
in {FStar_Syntax_Syntax.lbname = uu___98_864.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___98_864.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____865; FStar_Syntax_Syntax.lbeff = uu___98_864.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____868; FStar_Syntax_Syntax.lbattrs = uu___98_864.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___98_864.FStar_Syntax_Syntax.lbpos}))))))
...
in {FStar_Syntax_Syntax.ppname = uu___99_1099.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___99_1099.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1100}))
in ((uu____1098), (imp)))
end)))))
...
let uu____1226 = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___96_1236 -> (match (uu___96_1236) with
...
in {FStar_Syntax_Syntax.comp_univs = uu___100_1211.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___100_1211.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu____1212; FStar_Syntax_Syntax.effect_args = uu____1215; FStar_Syntax_Syntax.flags = uu____1226}))))
...
let uu___101_1256 = rc
in (

let uu____1257 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (inst s))
in {FStar_Syntax_Syntax.residual_effect = uu___101_1256.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____1257; FStar_Syntax_Syntax.residual_flags = uu___101_1256.FStar_Syntax_Syntax.residual_flags}))
