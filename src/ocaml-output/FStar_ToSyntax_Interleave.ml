...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___175_172 -> (match (uu___175_172) with
...
let uu___179_348 = impl1
in {FStar_Parser_AST.d = uu___179_348.FStar_Parser_AST.d; FStar_Parser_AST.drange = uu___179_348.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___179_348.FStar_Parser_AST.doc; FStar_Parser_AST.quals = uu___179_348.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = (krem_private)::impl1.FStar_Parser_AST.attrs})))
...
| FStar_Parser_AST.Tycon (uu____373, uu____374, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___176_414 -> (match (uu___176_414) with
...
| FStar_Parser_AST.Tycon (uu____790, uu____791, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___177_831 -> (match (uu___177_831) with
...
let uu____1387 = (FStar_Util.prefix_until (fun uu___178_1406 -> (match (uu___178_1406) with
