...
let contains_reflectable : qualifier Prims.list  ->  Prims.bool = (fun l -> (FStar_Util.for_some (fun uu___87_8198 -> (match (uu___87_8198) with
...
in {ppname = uu____8321; index = uu___94_8320.index; sort = uu___94_8320.sort})))
...
let uu___95_8370 = qi
in {qkind = uu___95_8370.qkind; antiquotes = aq})))
...
let mk_Tm_uinst : term  ->  universes  ->  term = (fun t uu___88_8803 -> (match (uu___88_8803) with
| [] -> begin
t
end
| us -> begin
...
let is_top_level : letbinding Prims.list  ->  Prims.bool = (fun uu___89_9269 -> (match (uu___89_9269) with
...
let is_implicit : aqual  ->  Prims.bool = (fun uu___90_9373 -> (match (uu___90_9373) with
...
let as_implicit : Prims.bool  ->  aqual = (fun uu___91_9386 -> (match (uu___91_9386) with
| true -> begin
...
let range_of_ropt : FStar_Range.range FStar_Pervasives_Native.option  ->  FStar_Range.range = (fun uu___92_9686 -> (match (uu___92_9686) with
| FStar_Pervasives_Native.None -> begin
...
in {ppname = uu___96_9758.ppname; index = uu____9759; sort = uu___96_9758.sort}))
end)))
...
in {ppname = uu____9929; index = uu___97_9928.index; sort = uu___97_9928.sort})))
...
let uu___98_10005 = fv
in (

let uu____10006 = (

let uu___99_10007 = fv.fv_name
in (
...
in {v = uu____10008; p = uu___99_10007.p}))
in {fv_name = uu____10006; fv_delta = uu___98_10005.fv_delta; fv_qual = uu___98_10005.fv_qual})))


let has_simple_attribute : term Prims.list  ->  Prims.string  ->  Prims.bool = (fun l s -> (FStar_List.existsb (fun uu___93_10035 -> (match (uu___93_10035) with
