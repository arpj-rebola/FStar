...
let uu___126_1595 = (comp_to_comp_typ_nouniv c)
in {FStar_Syntax_Syntax.comp_univs = uu___126_1595.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___126_1595.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___126_1595.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___126_1595.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = f})
in FStar_Syntax_Syntax.Comp (uu____1594))
in {FStar_Syntax_Syntax.n = uu____1593; FStar_Syntax_Syntax.pos = uu___125_1592.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___125_1592.FStar_Syntax_Syntax.vars})))
...
let uu___127_1641 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___127_1641.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___127_1641.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___127_1641.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___127_1641.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = fs})
in (

let uu___128_1642 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct1); FStar_Syntax_Syntax.pos = uu___128_1642.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___128_1642.FStar_Syntax_Syntax.vars}))
end))
...
let is_total_comp : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals (comp_effect_name c) FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___112_1736 -> (match (uu___112_1736) with
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___113_1753 -> (match (uu___113_1753) with
| FStar_Syntax_Syntax.TOTAL -> begin
true
end
| FStar_Syntax_Syntax.RETURN -> begin
...
let is_partial_return : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___115_1791 -> (match (uu___115_1791) with
| FStar_Syntax_Syntax.RETURN -> begin
true
end
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___116_1808 -> (match (uu___116_1808) with
| FStar_Syntax_Syntax.RETURN -> begin
true
end
| FStar_Syntax_Syntax.PARTIAL_RETURN -> begin
...
| FStar_Syntax_Syntax.Comp (ct) -> begin
(((is_total_comp c) || (is_pure_effect ct.FStar_Syntax_Syntax.effect_name)) || (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___117_1869 -> (match (uu___117_1869) with
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (((is_total_lcomp lc) || (is_pure_effect lc.FStar_Syntax_Syntax.eff_name)) || (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___118_1917 -> (match (uu___118_1917) with
| FStar_Syntax_Syntax.LEMMA -> begin
true
end
| uu____1920 -> begin
...
| FStar_Syntax_Syntax.Comp (c1) -> begin
((FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name FStar_Parser_Const.effect_ML_lid) || (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___119_2614 -> (match (uu___119_2614) with
...
let uu___129_2696 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___129_2696.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___129_2696.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = uu___129_2696.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___129_2696.FStar_Syntax_Syntax.flags}))
end))
...
let is_trivial_wp : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___120_2729 -> (match (uu___120_2729) with
| FStar_Syntax_Syntax.TOTAL -> begin
true
end
| FStar_Syntax_Syntax.RETURN -> begin
...
let equal_if = (fun uu___121_3427 -> (match (uu___121_3427) with
| true -> begin
Equal
end
| uu____3430 -> begin
...
let equal_iff = (fun uu___122_3438 -> (match (uu___122_3438) with
| true -> begin
Equal
end
| uu____3441 -> begin
...
let range_of_lbname : (FStar_Syntax_Syntax.bv, FStar_Syntax_Syntax.fv) FStar_Util.either  ->  FStar_Range.range = (fun uu___123_5719 -> (match (uu___123_5719) with
...
let uu___130_6149 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___130_6149.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___130_6149.FStar_Syntax_Syntax.sort})
in (
...
let uu___131_6338 = rc
in (

let uu____6339 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.close bs))
in {FStar_Syntax_Syntax.residual_effect = uu___131_6338.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____6339; FStar_Syntax_Syntax.residual_flags = uu___131_6338.FStar_Syntax_Syntax.residual_flags}))
...
let uu____7249 = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.find_opt (fun uu___124_7258 -> (match (uu___124_7258) with
...
let uu___132_7631 = rc
in (

let uu____7632 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.subst s))
in {FStar_Syntax_Syntax.residual_effect = uu___132_7631.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____7632; FStar_Syntax_Syntax.residual_flags = uu___132_7631.FStar_Syntax_Syntax.residual_flags}))
...
let uu____10647 = (un_uinst head1)
in uu____10647.FStar_Syntax_Syntax.n)
in ((uu____10646), (args)))
in (match (uu____10631) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____10666))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid) -> begin
...
let uu____10738 = (FStar_Syntax_Syntax.mk_binder b)
in (uu____10738)::[])
in (FStar_Syntax_Subst.open_term uu____10737 p))
...
let uu____10805 = (FStar_Syntax_Free.names p1)
in (FStar_Util.set_mem (FStar_Pervasives_Native.fst b1) uu____10805))
...
let uu____10855 = (head_and_args t)
...
let uu____10922 = (FStar_Syntax_Subst.compress head1)
in uu____10922.FStar_Syntax_Syntax.n)
in ((uu____10921), (args)))
in (match (uu____10906) with
| (FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____10944; FStar_Syntax_Syntax.vars = uu____10945}, (u)::[]), ((t1, uu____10948))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid) -> begin
...
let uu____11030 = (head_and_args t)
in (match (uu____11030) with
| (head1, args) -> begin
(
...
let uu____11097 = (FStar_Syntax_Subst.compress head1)
in uu____11097.FStar_Syntax_Syntax.n)
in ((uu____11096), (args)))
in (match (uu____11081) with
| (FStar_Syntax_Syntax.Tm_uinst ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____11119; FStar_Syntax_Syntax.vars = uu____11120}, (u)::[]), ((t1, uu____11123))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.auto_squash_lid) -> begin
FStar_Pervasives_Native.Some (((u), (t1)))
end
| uu____11170 -> begin
FStar_Pervasives_Native.None
...
let uu____11215 = (unmeta t)
in (head_and_args uu____11215))
in (match (uu____11198) with
| (head1, uu____11218) -> begin
(

let uu____11243 = (

let uu____11244 = (un_uinst head1)
in uu____11244.FStar_Syntax_Syntax.n)
...
let uu____11283 = (FStar_Syntax_Subst.compress t)
in uu____11283.FStar_Syntax_Syntax.n)
...
let uu____11425 = (arrow bs c)
in (FStar_Syntax_Syntax.mk_Total uu____11425))
in ((b), (uu____11424)))
in FStar_Pervasives_Native.Some (uu____11413))
end
| uu____11442 -> begin
FStar_Pervasives_Native.None
end))
in (FStar_Util.bind_opt uu____11269 (fun uu____11480 -> (match (uu____11480) with
| (b, c) -> begin
(

let uu____11517 = (FStar_Syntax_Subst.open_comp ((b)::[]) c)
...
let uu____11617 = (FStar_Syntax_Free.names t)
in (FStar_Util.set_mem bv uu____11617)))
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (uu____11795)) -> begin
(unmeta_monadic t)
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic_lift (uu____11807)) -> begin
(unmeta_monadic t)
end
| uu____11820 -> begin
f2
...
let aux = (fun f2 uu____11916 -> (match (uu____11916) with
| (lid, arity) -> begin
(

let uu____11925 = (

let uu____11942 = (unmeta_monadic f2)
in (head_and_args uu____11942))
...
let uu____11972 = ((is_constructor t1 lid) && (Prims.op_Equality (FStar_List.length args) arity))
...
let uu____12052 = (FStar_Syntax_Subst.compress t2)
in ((pats), (uu____12052)))
end
| uu____12065 -> begin
(([]), (t1))
...
let uu____12132 = (head_and_args t1)
in (match (uu____12132) with
| (t2, args) -> begin
(

let uu____12187 = (un_uinst t2)
in (

let uu____12188 = (FStar_All.pipe_right args (FStar_List.map (fun uu____12229 -> (match (uu____12229) with
| (t3, imp) -> begin
(

let uu____12248 = (unascribe t3)
in ((uu____12248), (imp)))
end))))
in ((uu____12187), (uu____12188))))
end)))
in (
...
let uu____12323 = (flat t1)
in ((qopt), (uu____12323)))
in (match (uu____12299) with
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____12363; FStar_Syntax_Syntax.vars = uu____12364}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____12367); FStar_Syntax_Syntax.pos = uu____12368; FStar_Syntax_Syntax.vars = uu____12369}, uu____12370))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____12472; FStar_Syntax_Syntax.vars = uu____12473}, (uu____12474)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____12477); FStar_Syntax_Syntax.pos = uu____12478; FStar_Syntax_Syntax.vars = uu____12479}, uu____12480))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____12597; FStar_Syntax_Syntax.vars = uu____12598}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____12601); FStar_Syntax_Syntax.pos = uu____12602; FStar_Syntax_Syntax.vars = uu____12603}, uu____12604))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(

let uu____12697 = (

let uu____12701 = (is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in FStar_Pervasives_Native.Some (uu____12701))
in (aux uu____12697 ((b)::out) t2))
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____12711; FStar_Syntax_Syntax.vars = uu____12712}, (uu____12713)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____12716); FStar_Syntax_Syntax.pos = uu____12717; FStar_Syntax_Syntax.vars = uu____12718}, uu____12719))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(

let uu____12828 = (

let uu____12832 = (is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in FStar_Pervasives_Native.Some (uu____12832))
in (aux uu____12828 ((b)::out) t2))
end
| (FStar_Pervasives_Native.Some (b), uu____12842) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____12895 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____12895) with
| (bs1, t2) -> begin
(

let uu____12904 = (patterns t2)
...
let uu____13046 = (un_squash t)
in (FStar_Util.bind_opt uu____13046 (fun t1 -> (

let uu____13062 = (head_and_args' t1)
...
let uu____13108 = (un_uinst hd1)
in uu____13108.FStar_Syntax_Syntax.n)
in ((uu____13107), ((FStar_List.length args))))
...
let uu____13168 = (un_squash t)
in (FStar_Util.bind_opt uu____13168 (fun t1 -> (

let uu____13183 = (arrow_one t1)
...
let uu____13200 = (is_tot_or_gtot_comp c)
in (not (uu____13200)))
...
let uu____13210 = (comp_to_comp_typ_nouniv c)
in uu____13210.FStar_Syntax_Syntax.result_typ)
in (

let uu____13211 = (is_free_in (FStar_Pervasives_Native.fst b) q)
in (match (uu____13211) with
| true -> begin
(

let uu____13218 = (patterns q)
...
let uu____13288 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort)
in (

let uu____13299 = (

let uu____13310 = (FStar_Syntax_Syntax.as_arg q)
in (uu____13310)::[])
in (uu____13288)::uu____13299))
in ((FStar_Parser_Const.imp_lid), (uu____13287)))
in BaseConn (uu____13282))
in FStar_Pervasives_Native.Some (uu____13281))
end)))
end))
end
| uu____13343 -> begin
...
let uu____13351 = (un_squash t)
in (FStar_Util.bind_opt uu____13351 (fun t1 -> (

let uu____13382 = (head_and_args' t1)
...
let uu____13437 = (un_uinst hd1)
in uu____13437.FStar_Syntax_Syntax.n)
in ((uu____13436), (args)))
in (match (uu____13421) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((a1, uu____13454))::((a2, uu____13456))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.dtuple2_lid) -> begin
(

let uu____13507 = (

let uu____13508 = (FStar_Syntax_Subst.compress a2)
in uu____13508.FStar_Syntax_Syntax.n)
in (match (uu____13507) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], q, uu____13515) -> begin
(

let uu____13550 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____13611 = (patterns q1)
in (match (uu____13611) with
| (pats, q2) -> begin
...
let uu____13696 = (destruct_sq_forall phi)
...
let uu____13718 = (destruct_sq_exists phi)
...
let uu____13741 = (destruct_base_conn phi)
in (FStar_Util.catch_opt uu____13741 (fun uu____13746 -> (

let uu____13747 = (destruct_q_conn phi)
in (FStar_Util.catch_opt uu____13747 (fun uu____13752 -> (

let uu____13753 = (destruct_sq_base_conn phi)
in (FStar_Util.catch_opt uu____13753 (fun uu____13758 -> (

let uu____13759 = (destruct_sq_forall phi)
in (FStar_Util.catch_opt uu____13759 (fun uu____13764 -> (

let uu____13765 = (destruct_sq_exists phi)
in (FStar_Util.catch_opt uu____13765 (fun uu____13769 -> FStar_Pervasives_Native.None))))))))))))))))))))))))
...
let uu____13783 = (FStar_Syntax_Subst.compress t)
in uu____13783.FStar_Syntax_Syntax.n)
in (match (uu____13782) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], e, uu____13790) -> begin
(

let uu____13825 = (FStar_Syntax_Subst.open_term ((b)::[]) e)
...
let uu____13859 = (is_free_in (FStar_Pervasives_Native.fst b1) e1)
...
let uu____13877 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____13877)::[])
in (mk_app t uu____13866))
end
| uu____13902 -> begin
e1
end)))
...
let uu____13916 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____13916)::[])
in (mk_app t uu____13905))
end)))
...
let uu____13963 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.delta_equational FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____13963))
in (

let uu____13964 = (

let uu____13965 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____13965))
in (

let uu____13968 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None)
in (close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____13958 a.FStar_Syntax_Syntax.action_univs uu____13964 FStar_Parser_Const.effect_Tot_lid uu____13968 [] pos))))
...
let uu____14030 = (FStar_Syntax_Syntax.as_arg t)
in (uu____14030)::[])
in ((reify_1), (uu____14019)))
in FStar_Syntax_Syntax.Tm_app (uu____14002))
in (FStar_Syntax_Syntax.mk uu____14001))
in (uu____13994 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let uu____14094 = (FStar_Ident.lid_of_str "Bogus.Effect")
in FStar_Const.Const_reflect (uu____14094))
in FStar_Syntax_Syntax.Tm_constant (uu____14093))
in (FStar_Syntax_Syntax.mk uu____14092))
in (uu____14085 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))
in (
...
let uu____14135 = (FStar_Syntax_Syntax.as_arg t)
in (uu____14135)::[])
in ((reflect_), (uu____14124)))
in FStar_Syntax_Syntax.Tm_app (uu____14107))
in (FStar_Syntax_Syntax.mk uu____14106))
in (uu____14099 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____14182) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_lazy (i) -> begin
(

let uu____14207 = (unfold_lazy i)
in (delta_qualifier uu____14207))
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
fv.FStar_Syntax_Syntax.fv_delta
end
| FStar_Syntax_Syntax.Tm_bvar (uu____14209) -> begin
FStar_Syntax_Syntax.delta_equational
end
| FStar_Syntax_Syntax.Tm_name (uu____14210) -> begin
FStar_Syntax_Syntax.delta_equational
end
| FStar_Syntax_Syntax.Tm_match (uu____14211) -> begin
FStar_Syntax_Syntax.delta_equational
end
| FStar_Syntax_Syntax.Tm_uvar (uu____14234) -> begin
FStar_Syntax_Syntax.delta_equational
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
FStar_Syntax_Syntax.delta_equational
end
| FStar_Syntax_Syntax.Tm_type (uu____14247) -> begin
FStar_Syntax_Syntax.delta_constant
end
| FStar_Syntax_Syntax.Tm_quoted (uu____14248) -> begin
FStar_Syntax_Syntax.delta_constant
end
| FStar_Syntax_Syntax.Tm_constant (uu____14255) -> begin
FStar_Syntax_Syntax.delta_constant
end
| FStar_Syntax_Syntax.Tm_arrow (uu____14256) -> begin
FStar_Syntax_Syntax.delta_constant
end
| FStar_Syntax_Syntax.Tm_uinst (t2, uu____14272) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_refine ({FStar_Syntax_Syntax.ppname = uu____14277; FStar_Syntax_Syntax.index = uu____14278; FStar_Syntax_Syntax.sort = t2}, uu____14280) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_meta (t2, uu____14289) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____14295, uu____14296) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____14338) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_abs (uu____14363, t2, uu____14365) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_let (uu____14390, t2) -> begin
(delta_qualifier t2)
end)))
...
let uu____14429 = (delta_qualifier t)
in (incr_delta_depth uu____14429)))
...
let uu____14438 = (FStar_Syntax_Subst.compress t)
in uu____14438.FStar_Syntax_Syntax.n)
...
let uu____14476 = (unmeta e)
in (head_and_args uu____14476))
...
let uu____14523 = (un_uinst head1)
in uu____14523.FStar_Syntax_Syntax.n)
in ((uu____14522), (args)))
in (match (uu____14507) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____14541) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____14565)::((hd1, uu____14567))::((tl1, uu____14569))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____14642 = (list_elements tl1)
in (FStar_Util.must uu____14642))
in (hd1)::uu____14639)
in FStar_Pervasives_Native.Some (uu____14636))
end
| uu____14651 -> begin
FStar_Pervasives_Native.None
end))
...
let rec apply_last : 'Auu____14675 . ('Auu____14675  ->  'Auu____14675)  ->  'Auu____14675 Prims.list  ->  'Auu____14675 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____14706 = (apply_last f xs)
in (x)::uu____14706)
end))
...
let uu____14769 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____14769))
in (FStar_Syntax_Syntax.mk uu____14768))
in (uu____14761 FStar_Pervasives_Native.None rng)))
in (
...
let uu____14792 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____14792 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____14791 args))
in (uu____14786 FStar_Pervasives_Native.None pos)))
in (
...
let uu____14814 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____14814 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____14813 args))
in (uu____14808 FStar_Pervasives_Native.None pos)))
in (
...
let uu____14819 = (FStar_Syntax_Syntax.iarg typ)
in (uu____14819)::[])
in (nil uu____14818 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____14853 = (

let uu____14854 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____14863 = (

let uu____14874 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____14883 = (

let uu____14894 = (FStar_Syntax_Syntax.as_arg a)
in (uu____14894)::[])
in (uu____14874)::uu____14883))
in (uu____14854)::uu____14863))
in (cons1 uu____14853 t.FStar_Syntax_Syntax.pos))) l uu____14817))))))
...
let uu____15332 = (FStar_ST.op_Bang debug_term_eq)
...
let uu____15554 = (unmeta_safe t1)
in (canon_app uu____15554))
in (

let t21 = (

let uu____15560 = (unmeta_safe t2)
in (canon_app uu____15560))
in (
...
let uu____15572 = (un_uinst t11)
in (FStar_Syntax_Subst.compress uu____15572))
in uu____15569.FStar_Syntax_Syntax.n)
in (
...
let uu____15577 = (un_uinst t21)
in (FStar_Syntax_Subst.compress uu____15577))
in uu____15574.FStar_Syntax_Syntax.n)
in ((uu____15568), (uu____15573))))
in (match (uu____15563) with
| (FStar_Syntax_Syntax.Tm_uinst (uu____15579), uu____15580) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____15589, FStar_Syntax_Syntax.Tm_uinst (uu____15590)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (FStar_Syntax_Syntax.Tm_delayed (uu____15599), uu____15600) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____15625, FStar_Syntax_Syntax.Tm_delayed (uu____15626)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (FStar_Syntax_Syntax.Tm_ascribed (uu____15651), uu____15652) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____15681, FStar_Syntax_Syntax.Tm_ascribed (uu____15682)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
...
let uu____15721 = (FStar_Syntax_Syntax.fv_eq x y)
in (check "fvar" uu____15721))
end
| (FStar_Syntax_Syntax.Tm_constant (c1), FStar_Syntax_Syntax.Tm_constant (c2)) -> begin
(

let uu____15726 = (FStar_Const.eq_const c1 c2)
in (check "const" uu____15726))
end
| (FStar_Syntax_Syntax.Tm_type (uu____15729), FStar_Syntax_Syntax.Tm_type (uu____15730)) -> begin
true
end
| (FStar_Syntax_Syntax.Tm_abs (b1, t12, k1), FStar_Syntax_Syntax.Tm_abs (b2, t22, k2)) -> begin
((

let uu____15788 = (eqlist (binder_eq_dbg dbg) b1 b2)
in (check "abs binders" uu____15788)) && (

let uu____15798 = (term_eq_dbg dbg t12 t22)
in (check "abs bodies" uu____15798)))
end
| (FStar_Syntax_Syntax.Tm_arrow (b1, c1), FStar_Syntax_Syntax.Tm_arrow (b2, c2)) -> begin
((

let uu____15847 = (eqlist (binder_eq_dbg dbg) b1 b2)
in (check "arrow binders" uu____15847)) && (

let uu____15857 = (comp_eq_dbg dbg c1 c2)
in (check "arrow comp" uu____15857)))
end
...
let uu____15875 = (term_eq_dbg dbg t12 t22)
in (check "refine formula" uu____15875)))
end
| (FStar_Syntax_Syntax.Tm_app (f1, a1), FStar_Syntax_Syntax.Tm_app (f2, a2)) -> begin
((

let uu____15932 = (term_eq_dbg dbg f1 f2)
in (check "app head" uu____15932)) && (

let uu____15936 = (eqlist (arg_eq_dbg dbg) a1 a2)
in (check "app args" uu____15936)))
end
| (FStar_Syntax_Syntax.Tm_match (t12, bs1), FStar_Syntax_Syntax.Tm_match (t22, bs2)) -> begin
((

let uu____16025 = (term_eq_dbg dbg t12 t22)
in (check "match head" uu____16025)) && (

let uu____16029 = (eqlist (branch_eq_dbg dbg) bs1 bs2)
in (check "match branches" uu____16029)))
end
| (FStar_Syntax_Syntax.Tm_lazy (uu____16046), uu____16047) -> begin
(

let uu____16048 = (

let uu____16050 = (unlazy t11)
in (term_eq_dbg dbg uu____16050 t21))
in (check "lazy_l" uu____16048))
end
| (uu____16052, FStar_Syntax_Syntax.Tm_lazy (uu____16053)) -> begin
(

let uu____16054 = (

let uu____16056 = (unlazy t21)
in (term_eq_dbg dbg t11 uu____16056))
in (check "lazy_r" uu____16054))
end
...
let uu____16101 = (eqlist (letbinding_eq_dbg dbg) lbs1 lbs2)
in (check "let lbs" uu____16101))) && (

let uu____16105 = (term_eq_dbg dbg t12 t22)
in (check "let body" uu____16105)))
end
| (FStar_Syntax_Syntax.Tm_uvar (u1, uu____16109), FStar_Syntax_Syntax.Tm_uvar (u2, uu____16111)) -> begin
...
let uu____16171 = (eq_quoteinfo qi1 qi2)
in (Prims.op_Equality uu____16171 Equal))
in (check "tm_quoted qi" uu____16169)) && (

let uu____16174 = (term_eq_dbg dbg qt1 qt2)
in (check "tm_quoted payload" uu____16174)))
end
...
let uu____16204 = (FStar_Ident.lid_equals n1 n2)
in (check "meta_monadic lid" uu____16204)) && (

let uu____16208 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic type" uu____16208)))
end
| (FStar_Syntax_Syntax.Meta_monadic_lift (s1, t13, ty1), FStar_Syntax_Syntax.Meta_monadic_lift (s2, t23, ty2)) -> begin
(((

let uu____16227 = (FStar_Ident.lid_equals s1 s2)
in (check "meta_monadic_lift src" uu____16227)) && (

let uu____16231 = (FStar_Ident.lid_equals t13 t23)
in (check "meta_monadic_lift tgt" uu____16231))) && (

let uu____16235 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic_lift type" uu____16235)))
end
| uu____16238 -> begin
(fail "metas")
end)
end
| (FStar_Syntax_Syntax.Tm_unknown, uu____16244) -> begin
(fail "unk")
end
| (uu____16246, FStar_Syntax_Syntax.Tm_unknown) -> begin
(fail "unk")
end
| (FStar_Syntax_Syntax.Tm_bvar (uu____16248), uu____16249) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_name (uu____16251), uu____16252) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_fvar (uu____16254), uu____16255) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_constant (uu____16257), uu____16258) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_type (uu____16260), uu____16261) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_abs (uu____16263), uu____16264) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_arrow (uu____16284), uu____16285) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_refine (uu____16301), uu____16302) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_app (uu____16310), uu____16311) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_match (uu____16329), uu____16330) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_let (uu____16354), uu____16355) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_uvar (uu____16370), uu____16371) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_meta (uu____16385), uu____16386) -> begin
(fail "bottom")
end
| (uu____16394, FStar_Syntax_Syntax.Tm_bvar (uu____16395)) -> begin
(fail "bottom")
end
| (uu____16397, FStar_Syntax_Syntax.Tm_name (uu____16398)) -> begin
(fail "bottom")
end
| (uu____16400, FStar_Syntax_Syntax.Tm_fvar (uu____16401)) -> begin
(fail "bottom")
end
| (uu____16403, FStar_Syntax_Syntax.Tm_constant (uu____16404)) -> begin
(fail "bottom")
end
| (uu____16406, FStar_Syntax_Syntax.Tm_type (uu____16407)) -> begin
(fail "bottom")
end
| (uu____16409, FStar_Syntax_Syntax.Tm_abs (uu____16410)) -> begin
(fail "bottom")
end
| (uu____16430, FStar_Syntax_Syntax.Tm_arrow (uu____16431)) -> begin
(fail "bottom")
end
| (uu____16447, FStar_Syntax_Syntax.Tm_refine (uu____16448)) -> begin
(fail "bottom")
end
| (uu____16456, FStar_Syntax_Syntax.Tm_app (uu____16457)) -> begin
(fail "bottom")
end
| (uu____16475, FStar_Syntax_Syntax.Tm_match (uu____16476)) -> begin
(fail "bottom")
end
| (uu____16500, FStar_Syntax_Syntax.Tm_let (uu____16501)) -> begin
(fail "bottom")
end
| (uu____16516, FStar_Syntax_Syntax.Tm_uvar (uu____16517)) -> begin
(fail "bottom")
end
| (uu____16531, FStar_Syntax_Syntax.Tm_meta (uu____16532)) -> begin
(fail "bottom")
end)))))
...
let uu____16567 = (term_eq_dbg dbg t1 t2)
in (check "arg tm" uu____16567))) (fun q1 q2 -> (

let uu____16579 = (

let uu____16581 = (eq_aqual q1 q2)
in (Prims.op_Equality uu____16581 Equal))
in (check "arg qual" uu____16579))) a1 a2))
...
let uu____16606 = (term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort b21.FStar_Syntax_Syntax.sort)
in (check "binder sort" uu____16606))) (fun q1 q2 -> (

let uu____16618 = (

let uu____16620 = (eq_aqual q1 q2)
in (Prims.op_Equality uu____16620 Equal))
in (check "binder qual" uu____16618))) b1 b2))
...
let uu____16640 = (FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name c21.FStar_Syntax_Syntax.effect_name)
in (check "comp eff" uu____16640)) && (

let uu____16644 = (term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ c21.FStar_Syntax_Syntax.result_typ)
in (check "comp result typ" uu____16644))) && true))))
and eq_flags_dbg : Prims.bool  ->  FStar_Syntax_Syntax.cflag  ->  FStar_Syntax_Syntax.cflag  ->  Prims.bool = (fun dbg f1 f2 -> true)
and branch_eq_dbg : Prims.bool  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  Prims.bool = (fun dbg uu____16654 uu____16655 -> (match (((uu____16654), (uu____16655))) with
| ((p1, w1, t1), (p2, w2, t2)) -> begin
(((

let uu____16782 = (FStar_Syntax_Syntax.eq_pat p1 p2)
in (check "branch pat" uu____16782)) && (

let uu____16786 = (term_eq_dbg dbg t1 t2)
in (check "branch body" uu____16786))) && (

let uu____16790 = (match (((w1), (w2))) with
| (FStar_Pervasives_Native.Some (x), FStar_Pervasives_Native.Some (y)) -> begin
(term_eq_dbg dbg x y)
end
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
...
in (check "branch when" uu____16790)))
end))
...
let uu____16853 = (eqsum (fun bv1 bv2 -> true) FStar_Syntax_Syntax.fv_eq lb1.FStar_Syntax_Syntax.lbname lb2.FStar_Syntax_Syntax.lbname)
in (check "lb bv" uu____16853)) && (

let uu____16862 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp lb2.FStar_Syntax_Syntax.lbtyp)
in (check "lb typ" uu____16862))) && (

let uu____16866 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef lb2.FStar_Syntax_Syntax.lbdef)
in (check "lb def" uu____16866))))
...
let uu____16883 = (FStar_ST.op_Bang debug_term_eq)
in (term_eq_dbg uu____16883 t1 t2))
...
| FStar_Syntax_Syntax.Tm_delayed (uu____16937) -> begin
(

let uu____16960 = (

let uu____16962 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____16962))
in ((Prims.parse_int "1") + uu____16960))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____16965 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____16965))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____16969 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____16969))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____16978 = (sizeof t1)
in ((FStar_List.length us) + uu____16978))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____16982) -> begin
(

let uu____17007 = (sizeof t1)
in (

let uu____17009 = (FStar_List.fold_left (fun acc uu____17024 -> (match (uu____17024) with
| (bv, uu____17034) -> begin
(

let uu____17039 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____17039))
end)) (Prims.parse_int "0") bs)
in (uu____17007 + uu____17009)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____17068 = (sizeof hd1)
in (

let uu____17070 = (FStar_List.fold_left (fun acc uu____17085 -> (match (uu____17085) with
| (arg, uu____17095) -> begin
(

let uu____17100 = (sizeof arg)
in (acc + uu____17100))
end)) (Prims.parse_int "0") args)
in (uu____17068 + uu____17070)))
end
| uu____17103 -> begin
(Prims.parse_int "1")
end))
...
let uu____17118 = (un_uinst t)
in uu____17118.FStar_Syntax_Syntax.n)
in (match (uu____17117) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let uu____17172 = (FStar_Options.set_options t s)
...
let uu____17189 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____17189 (fun a1 -> ())));
(match (sopt) with
| FStar_Pervasives_Native.None -> begin
()
end
...
let uu____17204 = (FStar_Options.internal_pop ())
in (match (uu____17204) with
| true -> begin
()
end
| uu____17207 -> begin
...
| FStar_Syntax_Syntax.Tm_delayed (uu____17236) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_name (x) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_uvar (uu____17263) -> begin
[]
end
...
| FStar_Syntax_Syntax.Tm_fvar (uu____17278) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_constant (uu____17279) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_lazy (uu____17280) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
[]
...
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____17289) -> begin
(

let uu____17314 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____17314) with
| (bs1, t2) -> begin
(

let uu____17323 = (FStar_List.collect (fun uu____17335 -> (match (uu____17335) with
| (b, uu____17345) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____17350 = (unbound_variables t2)
in (FStar_List.append uu____17323 uu____17350)))
end))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let uu____17375 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____17375) with
| (bs1, c1) -> begin
(

let uu____17384 = (FStar_List.collect (fun uu____17396 -> (match (uu____17396) with
| (b, uu____17406) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____17411 = (unbound_variables_comp c1)
in (FStar_List.append uu____17384 uu____17411)))
end))
end
| FStar_Syntax_Syntax.Tm_refine (b, t1) -> begin
(

let uu____17420 = (FStar_Syntax_Subst.open_term ((((b), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____17420) with
| (bs, t2) -> begin
(

let uu____17443 = (FStar_List.collect (fun uu____17455 -> (match (uu____17455) with
| (b1, uu____17465) -> begin
(unbound_variables b1.FStar_Syntax_Syntax.sort)
end)) bs)
in (

let uu____17470 = (unbound_variables t2)
in (FStar_List.append uu____17443 uu____17470)))
end))
end
| FStar_Syntax_Syntax.Tm_app (t1, args) -> begin
(

let uu____17499 = (FStar_List.collect (fun uu____17513 -> (match (uu____17513) with
| (x, uu____17525) -> begin
(unbound_variables x)
end)) args)
in (

let uu____17534 = (unbound_variables t1)
in (FStar_List.append uu____17499 uu____17534)))
end
| FStar_Syntax_Syntax.Tm_match (t1, pats) -> begin
(

let uu____17575 = (unbound_variables t1)
in (

let uu____17578 = (FStar_All.pipe_right pats (FStar_List.collect (fun br -> (

let uu____17593 = (FStar_Syntax_Subst.open_branch br)
in (match (uu____17593) with
| (p, wopt, t2) -> begin
(

let uu____17615 = (unbound_variables t2)
in (

let uu____17618 = (match (wopt) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____17615 uu____17618)))
end)))))
in (FStar_List.append uu____17575 uu____17578)))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, asc, uu____17632) -> begin
(

let uu____17673 = (unbound_variables t1)
in (

let uu____17676 = (

let uu____17679 = (match ((FStar_Pervasives_Native.fst asc)) with
...
let uu____17710 = (match ((FStar_Pervasives_Native.snd asc)) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____17679 uu____17710)))
in (FStar_List.append uu____17673 uu____17676)))
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), t1) -> begin
(

let uu____17751 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____17754 = (

let uu____17757 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (

let uu____17760 = (match (lb.FStar_Syntax_Syntax.lbname) with
| FStar_Util.Inr (uu____17765) -> begin
(unbound_variables t1)
end
| FStar_Util.Inl (bv) -> begin
(

let uu____17767 = (FStar_Syntax_Subst.open_term ((((bv), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____17767) with
| (uu____17788, t2) -> begin
(unbound_variables t2)
end))
end)
in (FStar_List.append uu____17757 uu____17760)))
in (FStar_List.append uu____17751 uu____17754)))
end
| FStar_Syntax_Syntax.Tm_let ((uu____17790, lbs), t1) -> begin
(

let uu____17810 = (FStar_Syntax_Subst.open_let_rec lbs t1)
in (match (uu____17810) with
| (lbs1, t2) -> begin
(

let uu____17825 = (unbound_variables t2)
in (

let uu____17828 = (FStar_List.collect (fun lb -> (

let uu____17835 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____17838 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (FStar_List.append uu____17835 uu____17838)))) lbs1)
in (FStar_List.append uu____17825 uu____17828)))
end))
end
...
let uu____17855 = (unbound_variables t1)
in (

let uu____17858 = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (args) -> begin
(FStar_List.collect (FStar_List.collect (fun uu____17897 -> (match (uu____17897) with
| (a, uu____17909) -> begin
(unbound_variables a)
end))) args)
end
| FStar_Syntax_Syntax.Meta_monadic_lift (uu____17918, uu____17919, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_monadic (uu____17925, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_labeled (uu____17931) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_desugared (uu____17940) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_named (uu____17941) -> begin
[]
end)
in (FStar_List.append uu____17855 uu____17858)))
end)))
...
| FStar_Syntax_Syntax.GTotal (t, uu____17948) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Total (t, uu____17958) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let uu____17968 = (unbound_variables ct.FStar_Syntax_Syntax.result_typ)
in (

let uu____17971 = (FStar_List.collect (fun uu____17985 -> (match (uu____17985) with
| (a, uu____17997) -> begin
(unbound_variables a)
end)) ct.FStar_Syntax_Syntax.effect_args)
in (FStar_List.append uu____17968 uu____17971)))
end))
...
let uu____18112 = (head_and_args h)
...
let uu____18174 = (FStar_Syntax_Subst.compress head1)
in uu____18174.FStar_Syntax_Syntax.n)
...
let uu____18251 = (extract_attr' attr_lid se.FStar_Syntax_Syntax.sigattrs)
in (match (uu____18251) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
let uu___133_18293 = se
in {FStar_Syntax_Syntax.sigel = uu___133_18293.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___133_18293.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___133_18293.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___133_18293.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs'})), (t)))
end)))
