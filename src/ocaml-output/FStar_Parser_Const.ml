...
let uu____1021 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____1021))
in (

let uu____1024 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1024 r))))
...
let uu____1045 = (FStar_Ident.text_of_id lid)
in (is_tuple_constructor_string uu____1045)))
...
let uu____1062 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____1062))
in (

let uu____1065 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1065 r))))
...
let uu____1093 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1093)))


let is_tuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (is_tuple_datacon_string f.FStar_Ident.str))


let mod_prefix_dtuple : Prims.int  ->  Prims.string  ->  FStar_Ident.lident = (fun n1 -> (match ((Prims.op_Equality n1 (Prims.parse_int "2"))) with
| true -> begin
pconst
end
| uu____1124 -> begin
...
let uu____1141 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____1141))
in (

let uu____1144 = (

let uu____1145 = (mod_prefix_dtuple n1)
in (uu____1145 t))
in (FStar_Ident.set_lid_range uu____1144 r))))


let is_dtuple_constructor_string : Prims.string  ->  Prims.bool = (fun s -> ((Prims.op_Equality s "Prims.dtuple2") || (FStar_Util.starts_with s "FStar.Pervasives.dtuple")))
...
let uu____1186 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____1186))
in (

let uu____1189 = (

let uu____1190 = (mod_prefix_dtuple n1)
in (uu____1190 t))
in (FStar_Ident.set_lid_range uu____1189 r))))


let is_dtuple_datacon_string : Prims.string  ->  Prims.bool = (fun s -> ((Prims.op_Equality s "Prims.Mkdtuple2") || (FStar_Util.starts_with s "FStar.Pervasives.Mkdtuple")))


let is_dtuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n1 -> (

let uu____1223 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1223)))


let is_dtuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (

let uu____1231 = (FStar_Ident.text_of_lid f)
in (is_dtuple_datacon_string uu____1231)))
