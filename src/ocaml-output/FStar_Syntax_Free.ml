...
let uu___95_55 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = (x)::[]; FStar_Syntax_Syntax.free_uvars = uu___95_55.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = uu___95_55.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = uu___95_55.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))


let singleton_uv : FStar_Syntax_Syntax.ctx_uvar  ->  (FStar_Syntax_Syntax.free_vars * FStar_Ident.lident FStar_Util.set) = (fun x -> (((

let uu___96_75 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___96_75.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = (x)::[]; FStar_Syntax_Syntax.free_univs = uu___96_75.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = uu___96_75.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu___97_95 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___97_95.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = uu___97_95.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = (x)::[]; FStar_Syntax_Syntax.free_univ_names = uu___97_95.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu___98_115 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___98_115.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = uu___98_115.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = uu___98_115.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = (x)::[]})), ((FStar_Pervasives_Native.snd no_free_vars))))
