...
let quals1 = (FStar_All.pipe_right x.FStar_Syntax_Syntax.sigquals (FStar_List.filter (fun uu___100_603 -> (match (uu___100_603) with
...
let uu___101_717 = lb
in {FStar_Syntax_Syntax.lbname = uu___101_717.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___101_717.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty'; FStar_Syntax_Syntax.lbeff = uu___101_717.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = tm'; FStar_Syntax_Syntax.lbattrs = uu___101_717.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___101_717.FStar_Syntax_Syntax.lbpos})
in (
...
let uu___102_778 = x
in {FStar_Syntax_Syntax.sigel = sigelt'; FStar_Syntax_Syntax.sigrng = uu___102_778.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___102_778.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___102_778.FStar_Syntax_Syntax.sigattrs}))::uu____729)
...
let uu___103_1174 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univs), (bnd'), (ty'), (mut'), (dc))); FStar_Syntax_Syntax.sigrng = uu___103_1174.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___103_1174.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___103_1174.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___103_1174.FStar_Syntax_Syntax.sigattrs}))::[])))
end
...
let uu___104_1196 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univs), (ty'), (res), (npars), (mut'))); FStar_Syntax_Syntax.sigrng = uu___104_1196.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___104_1196.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___104_1196.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___104_1196.FStar_Syntax_Syntax.sigattrs}))::[]))
end
