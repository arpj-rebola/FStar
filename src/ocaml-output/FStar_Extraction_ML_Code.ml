...
let escape_or : (FStar_BaseTypes.char  ->  Prims.string)  ->  FStar_BaseTypes.char  ->  Prims.string = (fun fallback uu___273_1710 -> if (Prims.op_Equality uu___273_1710 92 (*\*)) then begin
"\\\\"
end else begin
if (Prims.op_Equality uu___273_1710 32 (* *)) then begin
" "
end else begin
if (Prims.op_Equality uu___273_1710 8) then begin
"\\b"
end else begin
if (Prims.op_Equality uu___273_1710 9) then begin
"\\t"
end else begin
if (Prims.op_Equality uu___273_1710 13) then begin
"\\r"
end else begin
if (Prims.op_Equality uu___273_1710 10) then begin
"\\n"
end else begin
if (Prims.op_Equality uu___273_1710 39 (*'*)) then begin
"\\\'"
end else begin
if (Prims.op_Equality uu___273_1710 34) then begin
"\\\""
end else begin
if (FStar_Util.is_letter_or_digit uu___273_1710) then begin
(FStar_Util.string_of_char uu___273_1710)
end else begin
if (FStar_Util.is_punctuation uu___273_1710) then begin
(FStar_Util.string_of_char uu___273_1710)
end else begin
if (FStar_Util.is_symbol uu___273_1710) then begin
(FStar_Util.string_of_char uu___273_1710)
end else begin
(fallback uu___273_1710)
end
end
end
end
