...
let uu____5237 = (FStar_List.choose (fun uu___94_5242 -> (match (uu___94_5242) with
| Doc (d1) -> begin
...
let uu____5253 = (FStar_List.choose (fun uu___95_5262 -> (match (uu___95_5262) with
...
let qualifiers = (FStar_List.choose (fun uu___96_5288 -> (match (uu___96_5288) with
| Qualifier (q) -> begin
...
let ds2 = (d)::ds1
in ((FStar_List.iter (fun uu___97_7251 -> (match (uu___97_7251) with
...
let name_of_char = (fun uu___98_7292 -> (match (uu___98_7292) with
| 38 (*&*) -> begin
"Amp"
end
| 64 (*@*) -> begin
...
let string_of_let_qualifier : let_qualifier  ->  Prims.string = (fun uu___99_7485 -> (match (uu___99_7485) with
| NoLetQualifier -> begin
""
end
| Rec -> begin
...
let imp_to_string : imp  ->  Prims.string = (fun uu___100_7539 -> (match (uu___100_7539) with
| Hash -> begin
"#"
end
| uu____7542 -> begin
...
let uu____8369 = (FStar_All.pipe_right (FStar_List.append binders ((FStar_Util.Inr (t))::[])) (FStar_List.map (fun uu___101_8401 -> (match (uu___101_8401) with
...
and aqual_to_string : arg_qualifier FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___102_8613 -> (match (uu___102_8613) with
...
and attrs_opt_to_string : term Prims.list FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___103_8769 -> (match (uu___103_8769) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let id_of_tycon : tycon  ->  Prims.string = (fun uu___104_8890 -> (match (uu___104_8890) with
