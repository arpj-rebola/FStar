...
let as_pair : 'Auu____290 . 'Auu____290 Prims.list  ->  ('Auu____290 * 'Auu____290) = (fun uu___403_301 -> (match (uu___403_301) with
| (a)::(b)::[] -> begin
((a), (b))
end
| uu____306 -> begin
...
let flag_of_qual : FStar_Syntax_Syntax.qualifier  ->  FStar_Extraction_ML_Syntax.meta FStar_Pervasives_Native.option = (fun uu___404_321 -> (match (uu___404_321) with
...
let uu___414_1302 = empty_iface
in {iface_module_name = uu___414_1302.iface_module_name; iface_bindings = fvs; iface_tydefs = uu___414_1302.iface_tydefs; iface_type_names = uu___414_1302.iface_type_names}))


let iface_of_tydefs : FStar_Extraction_ML_UEnv.tydef Prims.list  ->  iface = (fun tds -> (

let uu___415_1313 = empty_iface
in (

let uu____1314 = (FStar_List.map (fun td -> td.FStar_Extraction_ML_UEnv.tydef_fv) tds)
in {iface_module_name = uu___415_1313.iface_module_name; iface_bindings = uu___415_1313.iface_bindings; iface_tydefs = tds; iface_type_names = uu____1314})))


let iface_of_type_names : FStar_Syntax_Syntax.fv Prims.list  ->  iface = (fun fvs -> (

let uu___416_1329 = empty_iface
in {iface_module_name = uu___416_1329.iface_module_name; iface_bindings = uu___416_1329.iface_bindings; iface_tydefs = uu___416_1329.iface_tydefs; iface_type_names = fvs}))
...
let gamma = (FStar_List.collect (fun uu___405_1548 -> (match (uu___405_1548) with
...
let assumed = (FStar_Util.for_some (fun uu___406_1781 -> (match (uu___406_1781) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____1784 -> begin
...
let uu____1818 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___407_1825 -> (match (uu___407_1825) with
...
let uu____1893 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___408_1899 -> (match (uu___408_1899) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
...
let uu____2378 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___409_2384 -> (match (uu___409_2384) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| uu____2387 -> begin
...
let uu___417_3353 = empty_iface
in {iface_module_name = g.FStar_Extraction_ML_UEnv.currentModule; iface_bindings = uu___417_3353.iface_bindings; iface_tydefs = uu___417_3353.iface_tydefs; iface_type_names = uu___417_3353.iface_type_names})
in (
...
in {FStar_Extraction_ML_UEnv.env_tcenv = uu___418_3442.FStar_Extraction_ML_UEnv.env_tcenv; FStar_Extraction_ML_UEnv.env_bindings = uu____3443; FStar_Extraction_ML_UEnv.tydefs = (FStar_List.append iface1.iface_tydefs g.FStar_Extraction_ML_UEnv.tydefs); FStar_Extraction_ML_UEnv.type_names = (FStar_List.append iface1.iface_type_names g.FStar_Extraction_ML_UEnv.type_names); FStar_Extraction_ML_UEnv.currentModule = uu___418_3442.FStar_Extraction_ML_UEnv.currentModule})))
...
let uu____3979 = (FStar_Util.find_opt (fun uu___410_3984 -> (match (uu___410_3984) with
...
let uu___419_5075 = lb
in {FStar_Syntax_Syntax.lbname = uu___419_5075.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___419_5075.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___419_5075.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___419_5075.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef; FStar_Syntax_Syntax.lbattrs = uu___419_5075.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___419_5075.FStar_Syntax_Syntax.lbpos})))
in (
...
let uu___420_5314 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = uu___420_5314.FStar_Extraction_ML_Syntax.mllb_name; FStar_Extraction_ML_Syntax.mllb_tysc = uu___420_5314.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = uu___420_5314.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = uu___420_5314.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.mllb_meta = meta; FStar_Extraction_ML_Syntax.print_typ = uu___420_5314.FStar_Extraction_ML_Syntax.print_typ})
in (

let uu____5315 = (

let uu____5320 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___411_5327 -> (match (uu___411_5327) with
...
let uu___421_5381 = ml_lb1
in {FStar_Extraction_ML_Syntax.mllb_name = (FStar_Pervasives_Native.snd mname); FStar_Extraction_ML_Syntax.mllb_tysc = uu___421_5381.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = uu___421_5381.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = uu___421_5381.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.mllb_meta = uu___421_5381.FStar_Extraction_ML_Syntax.mllb_meta; FStar_Extraction_ML_Syntax.print_typ = uu___421_5381.FStar_Extraction_ML_Syntax.print_typ})))
end)))
end
| uu____5386 -> begin
(
...
in {FStar_Syntax_Syntax.sigel = uu____5484; FStar_Syntax_Syntax.sigrng = uu___422_5483.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___422_5483.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___422_5483.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___422_5483.FStar_Syntax_Syntax.sigattrs}))
in (
...
let uu____5522 = (FStar_Util.find_map quals (fun uu___412_5527 -> (match (uu___412_5527) with
...
let uu____5553 = (FStar_Util.find_map quals (fun uu___413_5559 -> (match (uu___413_5559) with
...
in {FStar_Extraction_ML_UEnv.env_tcenv = uu____5675; FStar_Extraction_ML_UEnv.env_bindings = uu___423_5674.FStar_Extraction_ML_UEnv.env_bindings; FStar_Extraction_ML_UEnv.tydefs = uu___423_5674.FStar_Extraction_ML_UEnv.tydefs; FStar_Extraction_ML_UEnv.type_names = uu___423_5674.FStar_Extraction_ML_UEnv.type_names; FStar_Extraction_ML_UEnv.currentModule = name}))
in (
