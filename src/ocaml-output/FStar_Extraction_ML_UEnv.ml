...
let x = (FStar_Util.find_map g.env_bindings (fun uu___236_900 -> (match (uu___236_900) with
...
let try_lookup_fv : uenv  ->  FStar_Syntax_Syntax.fv  ->  exp_binding FStar_Pervasives_Native.option = (fun g fv -> (FStar_Util.find_map g.env_bindings (fun uu___237_928 -> (match (uu___237_928) with
...
let x = (FStar_Util.find_map g.env_bindings (fun uu___238_973 -> (match (uu___238_973) with
...
let uu___240_1088 = g
in {env_tcenv = tcenv; env_bindings = gamma; tydefs = uu___240_1088.tydefs; type_names = uu___240_1088.type_names; currentModule = uu___240_1088.currentModule}))))))
...
let has_collision = (FStar_List.existsb (fun uu___239_1227 -> (match (uu___239_1227) with
...
let uu___241_1327 = g
in {env_tcenv = tcenv; env_bindings = gamma; tydefs = uu___241_1327.tydefs; type_names = uu___241_1327.type_names; currentModule = uu___241_1327.currentModule})), (mlident), (exp_binding)))))))))))
...
let uu___242_1536 = g
in {env_tcenv = uu___242_1536.env_tcenv; env_bindings = gamma; tydefs = uu___242_1536.tydefs; type_names = uu___242_1536.type_names; currentModule = uu___242_1536.currentModule})), (mlsymbol), (exp_binding)))))))
end)))
end
| uu____1537 -> begin
...
let uu___243_1730 = g
in {env_tcenv = uu___243_1730.env_tcenv; env_bindings = uu___243_1730.env_bindings; tydefs = (tydef)::g.tydefs; type_names = (fv)::g.type_names; currentModule = uu___243_1730.currentModule})), (tydef)))
end))))
...
let uu___244_1742 = g
in {env_tcenv = uu___244_1742.env_tcenv; env_bindings = uu___244_1742.env_bindings; tydefs = uu___244_1742.tydefs; type_names = (fv)::g.type_names; currentModule = uu___244_1742.currentModule}))
