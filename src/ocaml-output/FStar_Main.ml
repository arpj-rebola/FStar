...
let uu___480 : unit = (FStar_Version.dummy ())
...
let main : unit  ->  unit = (fun uu____910 -> (FStar_All.try_with (fun uu___482_920 -> (match (()) with
| () -> begin
((setup_hooks ());
(
...
end)) (fun uu___481_1010 -> ((handle_error uu___481_1010);
(FStar_All.exit (Prims.parse_int "1"));
))))
