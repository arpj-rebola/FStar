...
let uu___359_248 = g
in {FStar_TypeChecker_Env.guard_f = uu___359_248.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = solve_now; FStar_TypeChecker_Env.univ_ineqs = uu___359_248.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___359_248.FStar_TypeChecker_Env.implicits}))
in (

let g2 = (

let uu___360_250 = g1
in {FStar_TypeChecker_Env.guard_f = uu___360_250.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = defer; FStar_TypeChecker_Env.univ_ineqs = uu___360_250.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___360_250.FStar_TypeChecker_Env.implicits})
in g2));
)
end))
end)))
...
in {FStar_TypeChecker_Env.guard_f = uu____1645; FStar_TypeChecker_Env.deferred = uu___361_1644.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___361_1644.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___361_1644.FStar_TypeChecker_Env.implicits}))
end))
...
let should_not_inline_lc : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___341_1943 -> (match (uu___341_1943) with
...
let uu____2243 = (FStar_All.pipe_right flags1 (FStar_Util.for_some (fun uu___342_2249 -> (match (uu___342_2249) with
| FStar_Syntax_Syntax.SHOULD_NOT_INLINE -> begin
true
end
| uu____2252 -> begin
...
| uu____2257 -> begin
(FStar_All.pipe_right flags1 (FStar_List.collect (fun uu___343_2264 -> (match (uu___343_2264) with
...
let uu____2683 = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___344_2691 -> (match (uu___344_2691) with
| FStar_Syntax_Syntax.RETURN -> begin
...
let uu___362_2723 = g0
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___362_2723.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___362_2723.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___362_2723.FStar_TypeChecker_Env.implicits}))))))
end)))


let lcomp_has_trivial_postcondition : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> ((FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) || (FStar_Util.for_some (fun uu___345_2732 -> (match (uu___345_2732) with
...
let uu___363_3162 = x
in {FStar_Syntax_Syntax.ppname = uu___363_3162.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___363_3162.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = (FStar_Syntax_Util.comp_result c1)})
in (
...
let uu___364_3920 = retc1
in {FStar_Syntax_Syntax.comp_univs = uu___364_3920.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Parser_Const.effect_GHOST_lid; FStar_Syntax_Syntax.result_typ = uu___364_3920.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___364_3920.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = flags1})
...
(FStar_All.pipe_right flags1 (FStar_Util.for_some (fun uu___346_4193 -> (match (uu___346_4193) with
| FStar_Syntax_Syntax.SHOULD_NOT_INLINE -> begin
true
end
| uu____4196 -> begin
...
let uu___365_5196 = lc
in {FStar_Syntax_Syntax.eff_name = uu___365_5196.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___365_5196.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp_thunk = uu___365_5196.FStar_Syntax_Syntax.comp_thunk})), (FStar_TypeChecker_Env.trivial_guard));
)
end)
end
...
let uu___366_5302 = g
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___366_5302.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___366_5302.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___366_5302.FStar_TypeChecker_Env.implicits})
in (
...
let uu___367_5349 = lc
in {FStar_Syntax_Syntax.eff_name = uu___367_5349.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = uu___367_5349.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp_thunk = uu___367_5349.FStar_Syntax_Syntax.comp_thunk})
...
let uu___368_5443 = x
in {FStar_Syntax_Syntax.ppname = uu___368_5443.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___368_5443.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = lc.FStar_Syntax_Syntax.res_typ})
in (
...
let flags1 = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.collect (fun uu___347_5467 -> (match (uu___347_5467) with
| FStar_Syntax_Syntax.RETURN -> begin
(FStar_Syntax_Syntax.PARTIAL_RETURN)::[]
end
| FStar_Syntax_Syntax.PARTIAL_RETURN -> begin
...
let uu___369_5474 = g1
in {FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial; FStar_TypeChecker_Env.deferred = uu___369_5474.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = uu___369_5474.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = uu___369_5474.FStar_TypeChecker_Env.implicits})
in ((e), (lc1), (g2)))))))
end))
end)));
))
...
let decr_inst = (fun uu___348_6588 -> (match (uu___348_6588) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
let uu___370_9885 = x
in {FStar_Syntax_Syntax.ppname = uu___370_9885.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___370_9885.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t2}))) FStar_Pervasives_Native.None e2.FStar_Syntax_Syntax.pos)
end
| uu____9886 -> begin
e2
end)))
...
let uu___371_9888 = env1
in (

let uu____9889 = (env1.FStar_TypeChecker_Env.use_eq || (env1.FStar_TypeChecker_Env.is_pattern && (is_var e)))
in {FStar_TypeChecker_Env.solver = uu___371_9888.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___371_9888.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___371_9888.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___371_9888.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_sig = uu___371_9888.FStar_TypeChecker_Env.gamma_sig; FStar_TypeChecker_Env.gamma_cache = uu___371_9888.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___371_9888.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___371_9888.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___371_9888.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.attrtab = uu___371_9888.FStar_TypeChecker_Env.attrtab; FStar_TypeChecker_Env.is_pattern = uu___371_9888.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___371_9888.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___371_9888.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___371_9888.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___371_9888.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___371_9888.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___371_9888.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu____9889; FStar_TypeChecker_Env.is_iface = uu___371_9888.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___371_9888.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___371_9888.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___371_9888.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.phase1 = uu___371_9888.FStar_TypeChecker_Env.phase1; FStar_TypeChecker_Env.failhard = uu___371_9888.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___371_9888.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.uvar_subtyping = uu___371_9888.FStar_TypeChecker_Env.uvar_subtyping; FStar_TypeChecker_Env.tc_term = uu___371_9888.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___371_9888.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___371_9888.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___371_9888.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___371_9888.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___371_9888.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.normalized_eff_names = uu___371_9888.FStar_TypeChecker_Env.normalized_eff_names; FStar_TypeChecker_Env.fv_delta_depths = uu___371_9888.FStar_TypeChecker_Env.fv_delta_depths; FStar_TypeChecker_Env.proof_ns = uu___371_9888.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___371_9888.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___371_9888.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.postprocess = uu___371_9888.FStar_TypeChecker_Env.postprocess; FStar_TypeChecker_Env.is_native_tactic = uu___371_9888.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___371_9888.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___371_9888.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___371_9888.FStar_TypeChecker_Env.dsenv; FStar_TypeChecker_Env.nbe = uu___371_9888.FStar_TypeChecker_Env.nbe}))
in (
...
let short_bin_op = (fun f uu___349_10120 -> (match (uu___349_10120) with
| [] -> begin
...
let short_op_ite = (fun uu___350_10212 -> (match (uu___350_10212) with
| [] -> begin
FStar_TypeChecker_Common.Trivial
end
...
let uu____10648 = (FStar_Util.prefix_until (fun uu___351_10688 -> (match (uu___351_10688) with
...
let uu___372_11125 = sig_ctx
in {FStar_Syntax_Syntax.sigel = uu___372_11125.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___372_11125.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Unfold_for_unification_and_vcgen)::[]; FStar_Syntax_Syntax.sigmeta = uu___372_11125.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___372_11125.FStar_Syntax_Syntax.sigattrs})), (uu____11123)))))));
))


let check_sigelt_quals : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt  ->  unit = (fun env se -> (

let visibility = (fun uu___352_11143 -> (match (uu___352_11143) with
...
let reducibility = (fun uu___353_11154 -> (match (uu___353_11154) with
...
let assumption = (fun uu___354_11169 -> (match (uu___354_11169) with
...
let reification = (fun uu___355_11181 -> (match (uu___355_11181) with
...
let inferred = (fun uu___356_11194 -> (match (uu___356_11194) with
...
let has_eq = (fun uu___357_11235 -> (match (uu___357_11235) with
...
let uu____11338 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___358_11344 -> (match (uu___358_11344) with
