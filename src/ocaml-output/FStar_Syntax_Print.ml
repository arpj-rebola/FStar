...
let rec delta_depth_to_string : FStar_Syntax_Syntax.delta_depth  ->  Prims.string = (fun uu___213_6 -> (match (uu___213_6) with
...
let is_inr : 'Auu____425 'Auu____426 . ('Auu____425, 'Auu____426) FStar_Util.either  ->  Prims.bool = (fun uu___214_436 -> (match (uu___214_436) with
...
let filter_imp : 'Auu____450 . ('Auu____450 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list  ->  ('Auu____450 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___215_505 -> (match (uu___215_505) with
...
let lbname_to_string : FStar_Syntax_Syntax.lbname  ->  Prims.string = (fun uu___216_803 -> (match (uu___216_803) with
...
let qual_to_string : FStar_Syntax_Syntax.qualifier  ->  Prims.string = (fun uu___217_1040 -> (match (uu___217_1040) with
...
and subst_elt_to_string : FStar_Syntax_Syntax.subst_elt  ->  Prims.string = (fun uu___218_2633 -> (match (uu___218_2633) with
...
and attrs_to_string : FStar_Syntax_Syntax.attribute Prims.list  ->  Prims.string = (fun uu___219_2884 -> (match (uu___219_2884) with
| [] -> begin
""
end
| tms -> begin
...
and aqual_to_string' : Prims.string  ->  FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option  ->  Prims.string = (fun s uu___220_2924 -> (match (uu___220_2924) with
...
and arg_to_string : (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option)  ->  Prims.string = (fun uu___221_3093 -> (match (uu___221_3093) with
| (a, imp) -> begin
(
...
let uu____3313 = ((FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___222_3319 -> (match (uu___222_3319) with
...
in (not (uu____3351))) && (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___223_3357 -> (match (uu___223_3357) with
...
let uu____3376 = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.collect (fun uu___224_3389 -> (match (uu___224_3389) with
...
and metadata_to_string : FStar_Syntax_Syntax.metadata  ->  Prims.string = (fun uu___225_3432 -> (match (uu___225_3432) with
...
let rec emb_typ_to_string : FStar_Syntax_Syntax.emb_typ  ->  Prims.string = (fun uu___226_4618 -> (match (uu___226_4618) with
