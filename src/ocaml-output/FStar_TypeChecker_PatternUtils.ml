...
in {FStar_Syntax_Syntax.v = uu____730; FStar_Syntax_Syntax.p = uu___267_729.FStar_Syntax_Syntax.p})))
end))
end)))
end
| uu____764 -> begin
...
let uu___268_828 = x
in {FStar_Syntax_Syntax.ppname = uu___268_828.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___268_828.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = FStar_Syntax_Syntax.tun})), (FStar_TypeChecker_Env.trivial_guard), (env1))
end
| uu____829 -> begin
(
...
let uu___269_885 = x
in {FStar_Syntax_Syntax.ppname = uu___269_885.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___269_885.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})
in (
...
let uu___270_1053 = x
in {FStar_Syntax_Syntax.ppname = uu___270_1053.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___270_1053.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
...
let uu___271_1111 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (e))); FStar_Syntax_Syntax.p = uu___271_1111.FStar_Syntax_Syntax.p})
in (
...
let uu___272_1838 = p1
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.p = uu___272_1838.FStar_Syntax_Syntax.p})))))))
end))
end))
in (
