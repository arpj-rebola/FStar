...
let findIndex : 'Auu____6476 'Auu____6477 . ('Auu____6476 * 'Auu____6477) Prims.list  ->  'Auu____6476  ->  Prims.int = (fun l v1 -> (FStar_All.pipe_right l (FStar_List.index (fun uu___83_6515 -> (match (uu___83_6515) with
...
let issue_of_exn : Prims.exn  ->  issue FStar_Pervasives_Native.option = (fun uu___84_6810 -> (match (uu___84_6810) with
| Error (e, msg, r) -> begin
(
...
let handleable : Prims.exn  ->  Prims.bool = (fun uu___85_6860 -> (match (uu___85_6860) with
...
let r = (FStar_All.try_with (fun uu___87_7716 -> (match (()) with
| () -> begin
(

let r = (f ())
in FStar_Pervasives_Native.Some (r))
end)) (fun uu___86_7722 -> ((err_exn uu___86_7722);
FStar_Pervasives_Native.None;
)))
in (
