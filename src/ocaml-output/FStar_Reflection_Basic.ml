...
let brs1 = (FStar_List.map (fun uu___237_794 -> (match (uu___237_794) with
...
let maybe_dec = (FStar_List.tryFind (fun uu___238_946 -> (match (uu___238_946) with
...
let brs1 = (FStar_List.map (fun uu___239_1333 -> (match (uu___239_1333) with
| (pat, t1) -> begin
(
...
let uu___240_1583 = se
in {FStar_Syntax_Syntax.sigel = uu___240_1583.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___240_1583.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___240_1583.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___240_1583.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs}))
