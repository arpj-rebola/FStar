...
let filter_imp : 'Auu____74 . ('Auu____74 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list  ->  ('Auu____74 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___199_129 -> (match (uu___199_129) with
...
let name_of_op = (fun uu___200_510 -> (match (uu___200_510) with
| "Amp" -> begin
...
let rec aux = (fun body3 uu___201_2365 -> (match (uu___201_2365) with
| [] -> begin
body3
end
| (hd1)::tl1 -> begin
...
let rec last1 = (fun uu___202_2520 -> (match (uu___202_2520) with
| (hd1)::[] -> begin
(hd1)::[]
end
| (hd1)::tl1 -> begin
...
let rec last_two = (fun uu___203_2629 -> (match (uu___203_2629) with
| [] -> begin
...
let resugar_meta_desugared = (fun uu___204_5737 -> (match (uu___204_5737) with
...
let rec aux = (fun l uu___205_6360 -> (match (uu___205_6360) with
| [] -> begin
l
end
| (hd1)::tl1 -> begin
...
let resugar_qualifier : FStar_Syntax_Syntax.qualifier  ->  FStar_Parser_AST.qualifier FStar_Pervasives_Native.option = (fun uu___206_7401 -> (match (uu___206_7401) with
...
let resugar_pragma : FStar_Syntax_Syntax.pragma  ->  FStar_Parser_AST.pragma = (fun uu___207_7439 -> (match (uu___207_7439) with
...
let uu____7570 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___208_7577 -> (match (uu___208_7577) with
...
let uu____8764 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___209_8772 -> (match (uu___209_8772) with
...
let uu____9109 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___210_9117 -> (match (uu___210_9117) with
