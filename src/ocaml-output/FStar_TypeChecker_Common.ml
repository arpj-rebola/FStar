...
let as_tprob : prob  ->  FStar_Syntax_Syntax.typ problem = (fun uu___218_576 -> (match (uu___218_576) with
| TProb (p) -> begin
p
end
| uu____582 -> begin
...
let rec decr_delta_depth : FStar_Syntax_Syntax.delta_depth  ->  FStar_Syntax_Syntax.delta_depth FStar_Pervasives_Native.option = (fun uu___219_777 -> (match (uu___219_777) with
...
let rec aux = (fun out uu___220_1182 -> (match (uu___220_1182) with
| [] -> begin
out
end
| ((c, i))::rest -> begin
...
let uu___223_1353 = info
in (

let uu____1354 = (ty_map info.identifier_ty)
in {identifier = uu___223_1353.identifier; identifier_ty = uu____1354; identifier_range = use_range1}))
in (
...
let uu___224_1544 = table
in {id_info_enabled = uu___224_1544.id_info_enabled; id_info_db = uu___224_1544.id_info_db; id_info_buffer = (info)::table.id_info_buffer})))
...
let uu____1724 = (FStar_All.pipe_right gamma (FStar_List.map (fun uu___221_1737 -> (match (uu___221_1737) with
...
let uu____1821 = (FStar_Util.prefix_until (fun uu___222_1836 -> (match (uu___222_1836) with
